...
export function showWelcomeMessage() {
    if (welcomeMessage) {
        ...
        // Ensure proper positioning with respect to model banner
...
export function toggleSendStopButton() {
    ...
    if (!sendButton || !stopButton) {
        console.error('Send or stop button not found in the DOM');
        return;
    }
    ...
    try {
        ...
        if (!sendButton.classList.contains('hidden')) {
            ...
            console.log('Toggling from send to stop button');
            ...
            console.log('Toggling from stop to send button');
        ...
        console.error('Error toggling send/stop buttons:', error);
...
export function applyThinkingVisibility() {
    ...
    if (isCodeReload && bypassReasoningProcessing) {
        console.log('Using fast path for reasoning model with code blocks');
        if (getHideThinking()) {
...
export function updateActiveCharacterDisplay() {
    if (!activeCharacterDisplay) {
        console.error('Active character display element not found');
        return;
    }

    const activeCharacter = getActiveCharacter();
    console.log('Updating active character display:', activeCharacter);
    ...
    if (activeCharacter) {
        ...
        console.log('Character badge created and added to display');
    } else {
        ...
        console.log('No active character, hiding character display');
    }
