...
// Local storage keys
const WHATS_NEW_VERSION = '8.7'; // Updated for new features: image generation, IP/port verification checklist, message input improvements, chat bubble UI, import/export fixes, light theme fixes, auto-scroll feature
