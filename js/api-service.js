...
/**
 * Synthesizes speech from text using Pollinations.ai TTS API
...
export async function synthesizeSpeech(text, voice = 'nova') {
    // Prefix text with "Say verbatim:" to ensure literal recitation instead of conversational response
    const prefixedText = `Say verbatim: ${text}`;
