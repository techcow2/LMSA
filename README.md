...
The image generation feature uses a third-party API. When enabled, your data will be sent to external services, reducing local privacy. This feature is completely optional and can be enabled or disabled at any time in Settings. See [third-party API terms of service](https://pollinations.ai/terms).
